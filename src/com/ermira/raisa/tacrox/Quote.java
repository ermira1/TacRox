...
//This class displayed a listview with the quotes in the database on the screen
public class Quote extends ListActivity {
 ...
 //finishes thi activity and calls StartingApp activity when back button is pressed
 @Override
